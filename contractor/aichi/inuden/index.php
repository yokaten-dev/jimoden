      ...
      <div class="sec-content wrapper js-accordion-content">
        <div class="info-list">
          ...
          <dl>
            ...
            <dd>令和4年11月1日</dd>
            <dt>所在地</dt>
            <dd>〒465-0004<br />愛知県名古屋市名東区香南1丁目303番地</dd>
            <!--<dt>資本金</dt>
            <dd>xx万円</dd>-->
            <dt>代表者名</dt>
            <dd>代表　犬飼 孝則</dd>
    ...
    <section class="section sec-contact" id="contact">
      ...
      <div class="sec-content">
        ...
        <div class="contact-block contact-line" id="line">
          ...
          <p class="contact-caption">犬飼電気工事の<br class="br-sp" />公式LINEから相談したい方はこちら！</p>
          <p class="contact-area">（対応エリア：名古屋市名東区・近郊）</p>
          <p class="line-comment">＼ まずは友だち追加をお願いします！ ／</p>
          <div class="btn-line-friend-container"><a class="btn-line-friend" href="https://lin.ee/tmwB9Jn">友だち追加</a></div>
        ...
        <div class="contact-block contact-mail" id="mail">
          ...
          <!-- update: 企業名・対応エリア -->
          <p class="contact-caption">犬飼電気工事に<br class="br-sp" />メールで相談したい方はこちら！</p>
          <p class="contact-area">（対応エリア：名古屋市名東区・近郊）</p>
        </div>
        <!-- お問合せフォーム -->
        <div class="mail-form">
