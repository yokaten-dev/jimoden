...
<body id="contractor">
  ...
  <main class="main">
    ...
    <section class="mainvisual">
      <!-- update: エリア名・企業名 -->
      <h1 class="mv-title"><em>名古屋市南区</em>の電気工事店<br /><span>株式会社キーネックス</span></h1>
      <!-- update: 紹介画像・企業名 -->
      <div class="mv-image"><img src="img/mainvisual.jpg" alt="株式会社キーネックス" /></div>
    </section>
    <!-- 3点メリット -->
      ...
      <div class="sec-content wrapper js-accordion-content">
        <div class="info-list">
          ...
          <dl>
            ...
            <dd>平成27年4月6日</dd>
            <dt>所在地</dt>
            <dd>〒457-0069<br />愛知県名古屋市南区星園町3番地</dd>
            <dt>資本金</dt>
            <dd>800万円</dd>
            <dt>代表者名</dt>
            <dd>代表取締役 中島 健太</dd>
    ...
    <section class="section sec-contact">
      ...
      <div class="sec-content">
        ...
        <div class="contact-block contact-tel" id="tel">
          ...
          <p class="contact-caption">株式会社キーネックスに<br class="br-sp" />直接電話したい方はこちら！</p>
          <p class="contact-area">（対応エリア：名古屋市南区・近郊）</p>
          <p class="contact-tel-number">052-883-8633</p>
          <p class="contact-business-hours"><em>営業電話ご遠慮ください</em><br />受付時間 9:00-18:00（土日祝は除く）</p>
          <div class="btn-call-number-container"><a class="btn-call-number" href="tel:052-883-8633">電話をかける</a></div>
          <!-- セールスの方へお願い -->
        ...
        <div class="contact-block contact-line" id="line">
          ...
          <p class="contact-caption">株式会社キーネックスの<br class="br-sp" />公式LINEから相談したい方はこちら！</p>
          <p class="contact-area">（対応エリア：名古屋市南区・近郊）</p>
          <p class="line-comment">＼ まずは友だち追加をお願いします！ ／</p>
          <div class="btn-line-friend-container"><a class="btn-line-friend" href="https://lin.ee/CEaICEV">友だち追加</a></div>
        ...
        <div class="contact-block contact-mail" id="mail">
          ...
          <!-- update: 企業名・対応エリア -->
          <p class="contact-caption">株式会社キーネックスに<br class="br-sp" />メールで相談したい方はこちら！</p>
          <p class="contact-area">（対応エリア：名古屋市南区・近郊）</p>
        </div>
        <!-- お問合せフォーム -->
        <div class="mail-form">
