...
$site_top = "https://fan.jimoden.jp/key-nex/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "key-nex@outlook.jp";

//自動返信メールの送信元メールアドレス
//必ず実在するメールアドレスでかつ出来る限り設置先サイトのドメインと同じドメインのメールアドレスとすることを強く推奨します
$from = "key-nex@outlook.jp";
...
$Referer_check_domain = "fan.jimoden.jp";
...
$thanksPage = "https://fan.jimoden.jp/key-nex/button.html";
...
＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
株式会社 キーネックス　
〒457-0069 愛知県名古屋市名古屋市南区星園町３
TEL：052-883-8633 　FAX：052-883-8688
E-mail:key-nex@outlook.jp
＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝
